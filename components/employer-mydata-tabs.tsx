...
// Mirrors ClientMyDataTabs: the employer's My Data screen previously rendered
// only the data form, so it was the one role missing the Credentials tab.
export function EmployerMyDataTabs() {
  ...
  return (
    <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
      ...
      <div className="p-2">
        {activeTab === "data" && <EmployerDataTab employerId="" selfService />}
