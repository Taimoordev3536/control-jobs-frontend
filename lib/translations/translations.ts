...
const translations: Record<string, Record<string, any>> = {
  en: {
    banksHint: "History of bank operations (collections and payments to order with the bank).",
    ...
    noBankOperations: "No bank operations",
    bankTaskGenerated: "Bank task generated",
    nothingToClose: "Nothing to close for this period",
    commissionsList: "Commissions list",
    selfInvoiceNo: "Self-invoice No.",
    noCommissions: "No commissions yet",
    generateCommission: "Generate self-invoice",
    selectPartner: "Select a partner",
    generated: "Generated",
    orCreateManual: "Or create a manual self-invoice:",
    newSelfInvoice: "New self-invoice",
    ...
    newJobSubjectPlaceholder: "e.g. Saturday cleaning at North Store",
    changeSubjectPlaceholder: "e.g. Change the shift schedule",
    absenceSubjectPlaceholder: "e.g. Closed for holidays",
    startDateRequired: "Enter the start date",
    absenceRequestsSubtitle: "Request your absences and track their status",
    clientRequestsSubtitle: "Send requests to your manager and track their status",
    noResults: "No results",
    title: "Title",
    workerSurveysSubtitle: "Surveys for workers",
    clientSurveysSubtitle: "Surveys for clients",
    ...
    draft: "Draft",
    closed: "Closed",
    surveyTitlePlaceholder: "e.g. Satisfaction survey",
    ...
    questionTextRequired: "Each question needs text",
    choiceNeedsOptions: "Choice questions need at least 2 options",
    surveyCreated: "Survey created",
    ratingType: "Rating (0–10)",
    yesNoType: "Yes / No",
    ...
    surveysFillSubtitle: "Answer your pending surveys",
    noSurveysForYou: "You have no pending surveys.",
    consentRequired: "You must accept the privacy notice",
    answerAllRequired: "Answer the required questions",
    surveySubmitted: "Survey submitted. Thank you!",
    surveyPrivacyNotice: "Your answers will be processed by your company to improve the service, in accordance with the GDPR. You may exercise your rights of access, rectification and erasure.",
    surveyAnonymousNotice: "This survey is anonymous: your answers are not linked to your identity.",
    acceptPrivacyNotice: "I have read and accept the privacy notice",
    questionsTitle: "Questions",
    viewMyAnswers: "View my answers",
    anonymousNoData: "Anonymous survey — your answers are not stored against your identity.",
    notSatisfied: "Not satisfied",
    verySatisfied: "Very satisfied",
    retentionTitle: "Response retention",
    retentionDaysLabel: "Delete responses after (days)",
    retentionHelp: "Leave empty or 0 to keep responses indefinitely. Applies to all your surveys.",
    clientRequests: "Client requests",
    generateLastMonth: "Generate last month",
    generateLastMonthConfirm: "Generate any missing invoices, commissions and bank tasks for the previous month. This does not modify or delete already-issued invoices. Continue?",
    monthlyCloseDone: "Monthly close completed",
    hello: "Hello",
    noJobs: "No jobs",
    filters: "Filters",
    errorPageDescription: "We couldn't load this page. Please try again.",
    errorReference: "Reference",
    tryAgain: "Try again",
    backToDashboard: "Back to dashboard",
    stillCheckedIn: "You are still checked in",
    checkOutFirst: "Check out there before starting another job.",
    goToCurrentJob: "Go to my current job",
    alreadyCheckedIn: "Already checked in",
    alreadyCheckedInHere: "You are already checked in to this job.",
    since: "Since",
    ...
    workerNotCheckedIn: "Worker not checked in",
    ...
    live: "Live",
    enableBiometric: "Enable biometric verification (fingerprint / Face ID) for your check-ins.",
    biometricActive: "Biometric verification enabled",
    liveNow: "Live now",
    workingNow: "Working now",
    notCheckedIn: "Not checked in",
    accept: "Accept",
    noClientRequests: "No requests",
    reviewNotesPlaceholder: "Note for the client (optional)",
    ...
    workShort: "Work",
    rates: "Rates",
    tariffsHint: "Default rates applied when a client or worker has none of their own set.",
    calendarHint: "Mark public holidays (festivos). Click a day to toggle it.",
    holidayNamePlaceholder: "e.g. Christmas",
    absencesRequests: "Absence requests",
    ...
    incNoCheckin: "No check-in",
    incLate: "Late",
    incNoCheckout: "No check-out",
    noIncidents: "No incidents for this day",
    planner: "Planner",
    week: "Week",
    month: "Month",
    ...
    selectAll: "All",
    clear: "Clear",
    noOccupationData: "No scheduled occupation for this period",
    ...
    pickLocationFirst: "Pick a location on the map first",
    documents: "Documents",
    documentsSalaries: "Documents / Salaries",
    view: "View",
    from: "From",
    approved: "Approved",
    rejected: "Rejected",
    ...
    hoursLabel: "Hours line text",
    pricePerHour: "Price per hour",
    optionalBlankOmits: "Optional",
    salaryRates: "Salary rates",
    invoiceRates: "Billing rates",
    salaryReceipts: "Salary receipts",
    entry: "Entry",
    ...
    requestManualCheckin: "Request manual check-in",
    ...
    scheduled: "Scheduled",
    freeSchedule: "Free",
    noPending: "You have no pending check-ins. All up to date!",
    shift: "Shift",
    punctuality: "Punctuality",
    early: "Early",
    onTime: "On time",
    late: "Late",
    jobRunning: "Job running now",
    jobsRunning: "Jobs running now",
    noCheckinsYet: "No check-ins for this day.",
    changeRequest: "Change to a Job",
    subject: "Subject",
    ...
    error: "Error",
    noAnnouncements: "You have no announcements.",
    ...
    saved: "Saved",
    reqFullDay: "Full day",
    reqCheckIn: "Check-in only",
    reqCheckOut: "Check-out only",
    reqEdit: "Edit entry",
    mon: "Mon",
    tue: "Tue",
    wed: "Wed",
    ...
    verifyEmailInvalidTitle: "Invalid verification link",
    verifyEmailSuccessDescNamed: "{{email}} is now verified.",
    verifyEmailSuccessDescGeneric: "Your email has been confirmed.",
    verifyEmailSuccessSignIn: "You can now sign in.",
    verifyEmailGoToLogin: "Go to login",
    verifyEmailExpiredDesc: "This link has expired. Request a new verification email below.",
    verifyEmailInvalidDesc: "This link is invalid or has already been used.",
    verifyEmailResend: "Resend verification email",
    verifyEmailBackToLogin: "Back to login",
    verifyEmailToastNoEmail: "Enter your email on the login page to resend",
    verifyEmailToastSentTitle: "Verification email sent",
    verifyEmailToastSentDesc: "Check your inbox at",
    verifyEmailToastFailedTitle: "Failed to send",
...
surveyMonitoringValueTips: "Set a limit. If responses are under this value, an alert is triggered.",
  ...
  confirmDeleteWorkCenterDesc: "This action cannot be undone. The work center will be permanently deleted.",
    ...
    vatPercent: "% VAT",
    ivaTextParticularesTai: "VAT text on invoices to Individuals in the TAI zone",
    ivaTextAutonomosFueraTai: "VAT text on invoices to Self-employed/Companies outside the TAI zone",
    ibanAccount: "IBAN account",
    swiftBic: "SWIFT / BIC",
    selectTypeFirst: "Select a type first",
    selectCsvFile: "Select a CSV file",
    importQueued: "File received — import will be processed.",
    importCsvInfo: "You can import data in CSV format. Download the sample template to see the field names (in Spanish) that can be imported, and fill it in before uploading.",
    downloadSampleCsv: "Download sample CSV",
    csvFile: "CSV file",
    importDone: "Import processed",
    backupSettings: "Backup settings",
    cloudStorage: "Cloud storage",
    cloudConnected: "Cloud account connected",
    cloudConnectFailed: "Could not connect the cloud account",
    confirmDisconnect: "Disconnect this account?",
    disconnected: "Disconnected",
    credentialsNotSet: "Credentials not set up yet",
    connected: "Connected",
    connect: "Connect",
    ...
    size: "Size",
    restoreWarning: "Restoring replaces ALL current data with the selected backup. This cannot be undone — you will be logged out afterward.",
    availableBackups: "Available backups",
    confirmRestore: "This will REPLACE all current data with this backup. This cannot be undone. Continue?",
    confirmRestoreFinal: "Are you absolutely sure?",
    restoreDone: "Backup restored",
    rowsRestored: "rows restored",
    restoreFailed: "Restore failed",
    importTypeNotYet: "Import for this type isn't available yet. Create them from their dedicated form (they require tier/type and billing setup).",
    imported: "imported",
    skipped: "skipped",
    failed: "failed",
    row: "Row",
    ...
    fields: "Fields",
    questionAndAnswerRequired: "Question and answer are required",
    ...
    alertSignIn: "Check-in",
    alertSignOut: "Check-out",
    alertDelay: "Delay",
    ...
    affiliateLinkDesc: "Share this link to invite employers. Sign-ups are linked to your account.",
    marketingMaterials: "Marketing materials",
    noMaterialsYet: "No materials available yet.",
    copied: "Copied",
    close: "Close",
    bankAccountForCollections: "Bank account for collections",
  ...
  es: {
    banksHint: "Histórico de operaciones bancarias (cobros y pagos a ordenar al banco).",
    ...
    ordered: "Ordenada",
    markOrdered: "Marcar ordenada",
    noBankOperations: "Sin operaciones bancarias",
    bankTaskGenerated: "Tarea bancaria generada",
    nothingToClose: "Nada que cerrar en este periodo",
    commissionsList: "Lista de Comisiones",
    selfInvoiceNo: "Nº Autofactura",
    noCommissions: "Aún no hay comisiones",
    generateCommission: "Generar autofactura",
    selectPartner: "Selecciona un partner",
    generated: "Generada",
    orCreateManual: "O crea una autofactura manual:",
    newSelfInvoice: "Nueva autofactura",
    addAtLeastOneLine: "Añade al menos una línea",
    concept: "Concepto",
    newLine: "Nueva línea",
    fiscalBreakdown: "Desglose fiscal",
    taxBase: "Base imponible",
    retention: "Retención",
    totalToPay: "TOTAL A PAGAR",
    paymentDate: "Fecha de pago",
    markPaid: "Marcar pagada",
    commissionDetail: "Detalle de comisiones",
    commission: "Comisión",
    discount: "Descuento",
    paid: "Pagada",
    notFound: "No encontrado",
    noRecords: "Sin registros para este mes",
    labor: "Laboral",
    absence: "Ausencia",
    newRequest: "Nueva solicitud",
    requestSent: "Solicitud enviada",
    myRequests: "Mis solicitudes",
    newJobSubjectPlaceholder: "p. ej. Limpieza sábados en Tienda Norte",
    changeSubjectPlaceholder: "p. ej. Cambiar horario del turno",
    absenceSubjectPlaceholder: "p. ej. Cierre por vacaciones",
    startDateRequired: "Indica la fecha de inicio",
    absenceRequestsSubtitle: "Solicita tus ausencias y consulta su estado",
    clientRequestsSubtitle: "Envía solicitudes a tu gestor y consulta su estado",
    noResults: "Sin resultados",
    title: "Título",
    workerSurveysSubtitle: "Encuestas para trabajadores",
    clientSurveysSubtitle: "Encuestas para clientes",
    ...
    draft: "Borrador",
    closed: "Cerrada",
    surveyTitlePlaceholder: "p. ej. Encuesta de satisfacción",
    ...
    questionTextRequired: "Cada pregunta necesita texto",
    choiceNeedsOptions: "Las preguntas de opción necesitan al menos 2 opciones",
    surveyCreated: "Encuesta creada",
    ratingType: "Valoración (0–10)",
    yesNoType: "Sí / No",
    singleChoiceType: "Opción única",
    multiChoiceType: "Opción múltiple",
    textType: "Texto libre",
    noResponsesYet: "Aún no hay respuestas.",
    average: "Media",
    individualResponses: "Respuestas individuales",
    surveysFillSubtitle: "Responde tus encuestas pendientes",
    noSurveysForYou: "No tienes encuestas pendientes.",
    consentRequired: "Debes aceptar el aviso de privacidad",
    answerAllRequired: "Responde las preguntas obligatorias",
    surveySubmitted: "Encuesta enviada. ¡Gracias!",
    surveyPrivacyNotice: "Tus respuestas serán tratadas por tu empresa para mejorar el servicio, conforme al RGPD. Puedes ejercer tus derechos de acceso, rectificación y supresión.",
    surveyAnonymousNotice: "Esta encuesta es anónima: tus respuestas no se vinculan a tu identidad.",
    acceptPrivacyNotice: "He leído y acepto el aviso de privacidad",
    questionsTitle: "Preguntas",
    viewMyAnswers: "Ver mis respuestas",
    anonymousNoData: "Encuesta anónima — tus respuestas no se guardan con tu identidad.",
    notSatisfied: "Nada satisfecho",
    verySatisfied: "Muy satisfecho",
    retentionTitle: "Conservación de respuestas",
    retentionDaysLabel: "Eliminar respuestas después de (días)",
    retentionHelp: "Deja vacío o 0 para conservar las respuestas indefinidamente. Aplica a todas tus encuestas.",
    clientRequests: "Solicitudes de clientes",
    generateLastMonth: "Generar mes anterior",
    generateLastMonthConfirm: "Generar las facturas, comisiones y tareas de banco del mes anterior que falten. No modifica ni borra facturas ya emitidas. ¿Continuar?",
    monthlyCloseDone: "Cierre mensual completado",
    hello: "Hola",
    noJobs: "Sin trabajos",
    filters: "Filtros",
    errorPageDescription: "No hemos podido cargar esta página. Inténtalo de nuevo.",
    errorReference: "Referencia",
    tryAgain: "Reintentar",
    backToDashboard: "Volver al panel",
    stillCheckedIn: "Todavía tienes un fichaje abierto",
    checkOutFirst: "Ficha la salida antes de empezar otro trabajo.",
    goToCurrentJob: "Ir a mi trabajo actual",
    alreadyCheckedIn: "Ya has fichado",
    alreadyCheckedInHere: "Ya tienes la entrada fichada en este trabajo.",
    since: "Desde",
    needsAttention: "Necesita tu atención",
    allClear: "Todo al día",
    quickActions: "Acciones rápidas",
    openTickets: "Tickets abiertos",
    newSuggestions: "Sugerencias nuevas",
    bankTasks: "Tareas de banco",
    overdueInvoices: "Facturas vencidas",
    latestInvoices: "Últimas facturas",
    recentSignups: "Altas recientes",
    viewAll: "Ver todo",
    invitePartnerEmployer: "Invitar partner / empresa",
    newAnnouncement: "Nuevo comunicado",
    yourBusiness: "Tu negocio · este mes",
    commissionThisMonth: "Comisión del mes",
    pendingCollection: "Pendiente de cobro",
    activeEmployers: "Empresas activas",
    pendingInvitations: "Invitaciones pendientes",
    commissionToCollect: "Comisión por cobrar",
    myCommissions: "Mis comisiones",
    yourEmployers: "Tus empresas",
    inactive: "Inactiva",
    manualAttendance: "Fichaje manual",
    workerAbsences: "Ausencias",
    clientInvoices: "Facturas de clientes",
    todaysJobs: "Jobs de hoy",
    allJobs: "Todos los Jobs",
    searchJobs: "Buscar jobs…",
    allOccupations: "Todas las ocupaciones",
    allWorkCenters: "Todos los centros",
    allClients: "Todos los clientes",
    completed: "Completado",
    overview: "Resumen",
    workersToday: "Trabajadores hoy",
    checkedInNow: "Fichados ahora",
    workerNotCheckedIn: "Trabajador sin fichar",
    ...
    missingCheckin: "Fichaje pendiente",
    pendingSurveys: "Encuestas pendientes",
    mySchedule: "Mi horario",
    myPayslips: "Mis nóminas",
    thisWeek: "Esta semana",
    recentPayslips: "Nóminas recientes",
    live: "En vivo",
    enableBiometric: "Activa la verificación biométrica (huella / Face ID) para tus fichajes.",
    biometricActive: "Verificación biométrica activada",
    liveNow: "En vivo ahora",
    workingNow: "Trabajando ahora",
    notCheckedIn: "Sin fichar",
    accept: "Aceptar",
    noClientRequests: "No hay solicitudes",
    reviewNotesPlaceholder: "Nota para el cliente (opcional)",
    requestAccepted: "Solicitud aceptada",
    requestRejected: "Solicitud rechazada",
    invalidDateRange: "La fecha final debe ser igual o posterior a la inicial",
    send: "Enviar",
    presence: "Presencia",
    history: "Historial",
    ...
    workShort: "Trabajo",
    rates: "Tarifas",
    tariffsHint: "Tarifas por defecto que se aplican cuando un cliente o trabajador no tiene las suyas configuradas.",
    calendarHint: "Marca los festivos. Pulsa un día para activarlo o desactivarlo.",
    holidayNamePlaceholder: "p. ej. Navidad",
    absencesRequests: "Solicitudes de ausencias",
    absenceRequest: "Solicitud de ausencia",
    absVacation: "Vacaciones",
    absPermit: "Permiso",
    absSick: "Baja",
    absOther: "Otro",
    ...
    incNoCheckin: "Sin fichaje",
    incLate: "Retraso",
    incNoCheckout: "Sin salida",
    noIncidents: "Sin incidencias para este día",
    ...
    selectAll: "Todos",
    clear: "Limpiar",
    noOccupationData: "Sin ocupación programada para este periodo",
    searchAddress: "Buscar dirección",
    typeAddress: "Escribe una dirección…",
    radiusKm: "Radio (km)",
    onlyAvailable: "Solo disponibles",
    available: "Disponible",
    occupied: "Ocupado",
    noWorkersFound: "No se encontraron trabajadores",
    pickLocationFirst: "Selecciona una ubicación en el mapa primero",
    documents: "Documentos",
    documentsSalaries: "Documentos / Salarios",
    view: "Ver",
    from: "Desde",
    approved: "Aprobada",
    rejected: "Rechazada",
    ...
    hoursLabel: "Texto línea de horas",
    pricePerHour: "Precio por hora",
    optionalBlankOmits: "Opcional",
    salaryRates: "Tarifas de salario",
    invoiceRates: "Tarifas de facturación",
    salaryReceipts: "Recibos de salario",
    entry: "Entrada",
    checkedOut: "Fichado",
    inProgress: "En curso",
    ...
    extra: "Extra",
    method: "Método",
    noCheckin: "Sin fichaje",
    requestManualCheckin: "Solicitar fichaje manual",
    ...
    freeSchedule: "Libre",
    noPending: "No tienes fichajes pendientes. ¡Todo al día!",
    shift: "Turno",
    punctuality: "Puntualidad",
    early: "Anticipado",
    onTime: "A tiempo",
    late: "Tarde",
    jobRunning: "Job en ejecución ahora",
    jobsRunning: "Jobs en ejecución ahora",
    noCheckinsYet: "Sin fichajes para este día.",
    changeRequest: "Cambio en un Job",
    subject: "Asunto",
    sendRequest: "Enviar solicitud",
    response: "Respuesta",
    selectJob: "Selecciona un Job",
    laboral: "Laboral",
    laborable: "Laborable",
    newAbsenceRequest: "Nueva solicitud de ausencia",
    selectDates: "Selecciona las fechas",
    error: "Error",
    noAnnouncements: "No tienes comunicados.",
    salaryReceipt: "Recibo de Salario",
    invoice: "Factura",
    ...
    calculate: "Calcular",
    noReceiptsYet: "Aún no hay recibos",
    ...
    deleted: "Eliminado",
    saved: "Guardado",
    reqFullDay: "Día completo",
    reqCheckIn: "Solo entrada",
    reqCheckOut: "Solo salida",
    reqEdit: "Editar fichaje",
    mon: "Lun",
    tue: "Mar",
    wed: "Mié",
    thu: "Jue",
    ...
    verifyEmailExpiredTitle: "El enlace de verificación ha caducado",
    verifyEmailInvalidTitle: "Enlace de verificación no válido",
    verifyEmailSuccessDescNamed: "{{email}} ya está verificado.",
    verifyEmailSuccessDescGeneric: "Tu email ha sido confirmado.",
    verifyEmailSuccessSignIn: "Ya puedes iniciar sesión.",
    verifyEmailGoToLogin: "Ir a inicio de sesión",
    verifyEmailExpiredDesc: "Este enlace ha caducado. Solicita un nuevo email de verificación abajo.",
    verifyEmailInvalidDesc: "Este enlace no es válido o ya se ha utilizado.",
    verifyEmailResend: "Volver a enviar el email de verificación",
    verifyEmailBackToLogin: "Volver a inicio de sesión",
    verifyEmailToastNoEmail: "Introduce tu email en la página de inicio de sesión para reenviarlo",
    verifyEmailToastSentTitle: "Email de verificación enviado",
    verifyEmailToastSentDesc: "Revisa tu bandeja de entrada en",
    verifyEmailToastFailedTitle: "Error al enviar",
    ...
    vatPercent: "% I.V.A.",
    ivaTextParticularesTai: "Texto sobre el IVA en facturas a Particulares de la zona TAI",
    ivaTextAutonomosFueraTai: "Texto sobre el IVA en facturas a Autónomos/Empresas de fuera de la zona TAI",
    ibanAccount: "Cta. IBAN",
    swiftBic: "SWIFT / BIC",
    selectTypeFirst: "Selecciona primero un tipo",
    selectCsvFile: "Selecciona un archivo CSV",
    importQueued: "Archivo recibido — la importación se procesará.",
    importCsvInfo: "Puedes importar datos en formato CSV. Descarga la plantilla de ejemplo para ver los nombres de los campos (en español) que se pueden importar y rellénala antes de subirla.",
    downloadSampleCsv: "Descargar CSV de ejemplo",
    csvFile: "Archivo CSV",
    importDone: "Importación procesada",
    backupSettings: "Configuración de copias",
    cloudStorage: "Almacenamiento en la nube",
    cloudConnected: "Cuenta en la nube conectada",
    cloudConnectFailed: "No se pudo conectar la cuenta en la nube",
    confirmDisconnect: "¿Desconectar esta cuenta?",
    disconnected: "Desconectado",
    credentialsNotSet: "Credenciales aún no configuradas",
    connected: "Conectado",
    connect: "Conectar",
    disconnect: "Desconectar",
    storageDestination: "Destino de almacenamiento",
    notConnected: "no conectado",
    intervalHours: "Intervalo (horas)",
    keepLast: "Conservar últimas (copias)",
    scheduledBackups: "Copias programadas",
    localPath: "Ruta local (opcional)",
    backupNow: "Hacer copia ahora",
    backupHistory: "Historial de copias",
    noBackupsYet: "Aún no hay copias",
    backupCreated: "Copia creada",
    backupFailed: "Error al crear la copia",
    confirmDeleteBackup: "¿Eliminar esta copia?",
    size: "Tamaño",
    restoreWarning: "Restaurar reemplaza TODOS los datos actuales por la copia seleccionada. No se puede deshacer — se cerrará tu sesión después.",
    availableBackups: "Copias disponibles",
    confirmRestore: "Esto REEMPLAZARÁ todos los datos actuales por esta copia. No se puede deshacer. ¿Continuar?",
    confirmRestoreFinal: "¿Estás completamente seguro?",
    restoreDone: "Copia restaurada",
    rowsRestored: "filas restauradas",
    restoreFailed: "Error al restaurar",
    importTypeNotYet: "La importación de este tipo aún no está disponible. Créalos desde su formulario (requieren configuración de tarifa/tipo y facturación).",
    imported: "importados",
    skipped: "omitidos",
    failed: "fallidos",
    row: "Fila",
    ...
    fields: "Campos",
    questionAndAnswerRequired: "La pregunta y la respuesta son obligatorias",
    confirmDeleteFaq: "¿Eliminar esta pregunta frecuente?",
    allUsers: "Todos",
    question: "Pregunta",
    answer: "Respuesta",
    audience: "Audiencia",
    ...
    titular: "Titular",
    noCheckIn: "Sin fichaje",
    noJobsForDay: "No hay Jobs programados para este día",
    now: "Ahora",
    checkedIn: "Fichado",
    alertSignIn: "Entrada",
    alertSignOut: "Salida",
    alertDelay: "Retraso",
    alertDuration: "Duración",
    ...
    comingSoon: "Esta sección está en desarrollo.",
    ...
    affiliateLinkDesc: "Comparte este enlace para invitar empleadores. Los registros quedan vinculados a tu cuenta.",
    marketingMaterials: "Materiales de marketing",
    noMaterialsYet: "Aún no hay materiales disponibles.",
    copied: "Copiado",
    close: "Cerrar",
    bankAccountForCollections: "Cuenta bancaria para cobros",
