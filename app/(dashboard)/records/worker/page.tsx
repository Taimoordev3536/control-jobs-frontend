...
export default function WorkerRecordsPage() {
  ...
  const actionButtons = [
    ...
    {
      icon: ExcelIcon,
      onClick: () => exportToXLSX(rows, columns, "worker-records.xlsx"),
      title: t("exportExcel"),
      type: "excel" as const,
    },
    {
      icon: CsvIcon,
      onClick: () => exportToCSV(rows, columns, "worker-records.csv"),
      title: t("exportCsv"),
      type: "csv" as const,
    },
    {
      icon: PdfIcon,
      onClick: () => exportToPDF(rows, columns, "worker-records.pdf"),
      title: t("exportPdf"),
      type: "pdf" as const,
    },
  ]
