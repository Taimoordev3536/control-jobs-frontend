    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-full mx-auto bg-background">
        ...
        <div className="px-8 py-4">
          <div className="w-full">
            ...
            <div className="flex mb-4 border-b-2 border-primary pb-2">
              <div className="w-[70%] text-center font-semibold text-foreground">Billing Summary</div>
              <div className="w-[10%] text-center font-semibold text-foreground">Amount</div>
              <div className="w-[10%] text-center font-semibold text-foreground">Price</div>
              <div className="w-[10%] text-center font-semibold text-foreground">Total</div>
            </div>
        ...
        <div className="px-8 py-4">
                <div>
              <div className="flex justify-center items-center border-b-2 border-primary pb-2">
                <span className="font-semibold text-foreground">Service details</span>
              </div>
